...
type exp = 
    ...
    | Letrec of ide * exp * exp
		...
		| Empty of ide (*Costruttore del set vuoto*)
		| Singleton of exp * ide (*Costruttore di un set con un elemento solo*)
		| Union of exp * exp 
...
print_set_other stringset env0;;
Printf.printf "]\n";;
Printf.printf " - Inserisco \"Delfino\" -> stringset = [ ";;
...
Printf.printf " - For_all -> definisco l'insieme set0 contenente gli elementi (1,3,5) e controllo se la proprietà \"IsPositive\",\n              che restituisce True se un numero è maggiore o uguale di 0, è soddisfatta:\n\n";;
